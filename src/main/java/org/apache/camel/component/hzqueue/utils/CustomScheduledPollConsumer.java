 ...
 * This one is a fork of ScheduledPollConsumer and now is working well with error threshold
 */
public abstract class CustomScheduledPollConsumer extends DefaultConsumer implements Runnable, SuspendableService, PollingConsumerPollingStrategy {
    private static final Logger LOG = LoggerFactory.getLogger(CustomScheduledPollConsumer.class);
    ...
    // callbacks
    private Optional<String> idleBackoffEventConsumer = Optional.empty();
    private Optional<String> errorBackoffEventConsumer = Optional.empty();
    private ProducerTemplate producerTemplate;

    public CustomScheduledPollConsumer(Endpoint endpoint, Processor processor) {
    ...
    public void setIdleBackoffEventConsumer(Optional<String> idleBackoffEventConsumer) {
        this.idleBackoffEventConsumer = idleBackoffEventConsumer;
    }

    public void setErrorBackoffEventConsumer(Optional<String> errorBackoffEventConsumer) {
    ...
    protected void doStart() throws Exception {
        ...
        if (backoffMultiplier > 0) {
            ...
            LOG.warn("Using backoff[multiplier={}, idleThreshold={}, errorThreshold={}] on {}", new Object[]{backoffMultiplier, backoffIdleThreshold, backoffErrorThreshold, getEndpoint()});
        }
